...
**Team Members:** Subba Taniparti · Harini Mamidala · Christian Gaston · Bellary Naveen Vishal  
...
- **2026-09-23 — Cohort Finalization:** Onboarded Bellary Naveen Vishal and Christian Gaston; finalized 4-member research team — Team consensus
- **2026-09-23 — Dataset Benchmarking & Multi-Criteria Evaluation:** Evaluated five candidate datasets (Heart Disease UCI, Credit Card Default, Diabetes 130-Hospitals, Online Retail, NYC Taxi) against rubric criteria (feasibility, clinical/business relevance, demographic variables for ethics audit) — Bellary Naveen Vishal & Subba
- **2026-09-23 — Dataset Selection (Heart Disease UCI):** Selected Heart Disease UCI (Cleveland subset, $N=303$) for clinical clarity, complete feature sets, and demographic attributes permitting empirical fairness audits — Proposed by Bellary Naveen Vishal; unanimously approved by Harini, Christian, and Subba
...
- **2026-09-23 — Research Role & Section Allocation:** Distributed responsibilities across rubric sections aligned with team strengths:
  ...
  - **Bellary Naveen Vishal:** Dataset Exploration, Preprocessing Architecture & EDA Visualizations (Section 2)
...
- **2026-09-24 — Dataset Selection & Recommendation Notebook Contribution (PR #1):** Bellary Naveen Vishal completed candidate dataset benchmarking and rubric scoring analysis in `part1/notebooks/Gropup_Project_1.ipynb`, submitting Pull Request #1 (`feature/dataset-selection-analysis`) which was reviewed and merged into `main` — Bellary Naveen Vishal & Subba
- **2026-09-24 — Data Hygiene & Exact Duplicate Removal:** Identified 1 exact duplicate patient row during initial profiling and removed it ($303 \to 302$ patients) to eliminate cross-split data leakage — Harini & Bellary Naveen Vishal; verified by team
...
- **2026-09-24 — Imputation Strategy Formulation:** Formally audited missingness (0 missing values across all 302 patients); explicitly rejected forward-fill imputation suggested in assignment hints as theoretically unsound for unordered clinical records — Harini, Bellary Naveen Vishal & Subba
- **2026-09-24 — Categorical Encoding Architecture:** Replaced nominal integer representations (`cp`, `restecg`, `slope`, `ca`, `thal`) with one-hot dummy variables (`drop_first=True`) rather than treating them as continuous ordinal integers — Harini & Bellary Naveen Vishal; implemented into preprocessing
...
- **2026-09-24 — Validation Rigor for Small Samples (RQ2/H2):** Supplemented 5-fold Stratified K-Fold CV with a 30-iteration Monte Carlo CV simulation ($75/25$ split) to quantify metric variance and ensure model ranking stability on $N=302$ — Bellary Naveen Vishal & Subba
...
- **2026-09-25 — Final Report & Codebase Consolidation:** Finalized submission artifacts; audited and corrected label polarity in exploratory notebooks, standardized master analysis notebook (`Group8_Part1_Heart_Disease_Final_Analysis.ipynb`), archived superseded report drafts, and designated `Group8_Part1_Report.docx` as the authoritative report deliverable — Team consensus
...
- **2026-09-25 — Document Iterations & Author Name Correction:** Bellary Naveen Vishal requested a formal correction to his full name in the report ("Bellary Naveen Vishal"). Updated the contributor name in `Group8_Part1_Report.docx`, committed changes to Git, and shared the updated draft with the team — Bellary Naveen Vishal & Subba
- **2026-09-25 — Revisions & Quality Assurance Review:** Addressed feedback and items flagged by Harini during comprehensive document review, and generated the revised report deliverable — Harini & Subba
- **2026-09-25 — Preprocessing & Visualization Notebook Contribution:** Harini Mamidala developed and contributed her standalone exploration notebook (`part1/notebooks/Harini_Mamidala_Preprocessing_Visualization.ipynb`) covering data profiling, distribution visualisations, and categorical preprocessing — Harini
- **2026-09-25 — Final Deliverables & Repository Updates:** Finalizing submission assets ahead of the deadline; transmitted the final report via email (Outlook) to the research cohort, committed final files to GitHub, and updated the shared Google Colab notebook per Harini's recommendations — Subba & Harini; shared with team
- **2026-09-25 — Pending Actions & Submission Quality Hold:** Enacted a temporary hold on the final LMS submission until 2026-09-26 afternoon to accommodate Christian's final review/audit and catch any last-minute flags — Christian & Team consensus

---

### Governance & Summary of Deliverable Files
- **Primary Written Report:** `part1/report/Group8_Part1_Report.docx` (authoritative submission deliverable)
- **Archived Drafts:** `part1/report/drafts/` (`Draft_v2.docx`, `Draft_v3.docx`)
- **Master Interactive Notebook:** `part1/notebooks/Group8_Part1_Heart_Disease_Final_Analysis.ipynb`
- **Publication Figures:** `part1/figures/` (`fig1_eda.png`, `fig3_confusion.png`, `fig5_fairness.png`)
- **Supporting Individual Notebooks:** `part1/notebooks/` (`Bellary_Naveen_Vishal_Data_Exploration.ipynb`, `Harini_Mamidala_Preprocessing_Visualization.ipynb`, `Subba_Taniparti_Model_Development.ipynb`, `Group8_Project_1_Data_loading.ipynb`)
