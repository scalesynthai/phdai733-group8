...
- **2026-09-23 — Collaborative Infrastructure:** Established WhatsApp as the primary real-time communication channel and synchronized scheduling for sprint check-ins — Harini
...
- **2026-09-23 — Research Role & Section Allocation:** Distributed responsibilities across rubric sections aligned with team strengths:
  - **Christian Gaston:** Problem Framing, Clinical Translation, Triage Asymmetry Analysis (Section 1) & Report Synthesis (Lead)
  - **Harini Mamidala:** Dataset Exploration, Preprocessing Architecture & EDA Visualizations (Section 2)
  - **Subba Taniparti:** Leakage-Free Model Pipeline, Hyperparameter Tuning & Cross-Validation Architecture (Section 3)
  - **Naveen Vishal Bellary:** Candidate Dataset Analysis, Feature Engineering & Empirical Ethics/Fairness Audit (Section 4)
  — Agreed collaboratively
- **2026-09-24 — Data Hygiene & Exact Duplicate Removal:** Identified 1 exact duplicate patient row during initial profiling and removed it ($303 \to 302$ patients) to eliminate cross-split data leakage — Harini; verified by team
...
- **2026-09-24 — Imputation Strategy Formulation:** Formally audited missingness (0 missing values across all 302 patients); explicitly rejected forward-fill imputation suggested in assignment hints as theoretically unsound for unordered clinical records — Harini; supported by team
